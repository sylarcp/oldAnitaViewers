...
#pragma implementation "HKViewer.h"
#endif
...
IMPLEMENT_CLASS(HKViewer,wxDialog)
BEGIN_EVENT_TABLE(HKViewer,wxDialog)
 EVT_BUTTON(TERM7_CLEAR_BUTTON_ID, HKViewer::OnClear)
 EVT_BUTTON(SAVE_FILE7_ID, HKViewer::SaveFile)
 //EVT_CHOICE(wxID_ANY,GpsPosViewer::FileSelect)
END_EVENT_TABLE()

// Constructor
HKViewer::HKViewer(wxWindow *parent){
 Create(parent,wxID_ANY,_T("HK Viewer"),wxDefaultPosition,wxSize(400,300),
 ...
 wxButton *clearButton=new wxButton(this,TERM7_CLEAR_BUTTON_ID,_("Clear"));
 wxButton *saveFileButton=new wxButton(this,SAVE_FILE7_ID,_("Save File"));
/*
...
void HKViewer::HKData(const HkDataStruct_t  &hk){
  //(*m1_display).Clear();
...
void HKViewer::OnClear(wxCommandEvent &WXUNUSED(event)){
  m1_display->Clear();
}
void HKViewer::SaveFile( wxCommandEvent &WXUNUSED(event) ){  
